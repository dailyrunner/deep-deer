...
# 환경 변수 설정
# OpenAI API 키는 환경 변수에서 가져옴 (export OPENAI_API_KEY="your-key" 또는 .env 파일 사용)
if not os.getenv("OPENAI_API_KEY"):
    raise ValueError("OPENAI_API_KEY 환경 변수가 설정되지 않았습니다. export OPENAI_API_KEY='your-key' 명령으로 설정하세요.")

# Hugging Face 토큰 (환경 변수로 설정)
